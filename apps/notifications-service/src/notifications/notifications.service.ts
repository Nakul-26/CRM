 ...
 * apps/api/src/modules/notifications/notifications.service.ts (Phase 18) —
 * same queries, same "every query scoped to the caller's own userId" rule,
 * just against this service's own database/connection.
 */
@Injectable()
