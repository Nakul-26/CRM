...
async function main() {
    ...
    if (!sourceUrl)
        throw new Error("MONOLITH_DATABASE_URL is not set");
    if (!targetUrl)
        throw new Error("DATABASE_URL is not set");
    const source = (0, postgres_1.default)(sourceUrl, { max: 1 });
    const target = (0, postgres_1.default)(targetUrl, { max: 1 });
    try {
...
//# sourceMappingURL=backfill-from-monolith.js.map